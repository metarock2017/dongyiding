...
<script type="text/javascript">
    ...
    function doRequestUsingGet() {
        ...
        //words表单
        var queryString = "http://dyd223.s3.natapp.cc/createroom";
    ...
    function change(people) {
        ...
        var url = 'http://dyd223.s3.natapp.cc/createroom';
    ...
    var w_btn = document.getElementById("w_btn");
    w_btn.onclick = function () {
        window.location.href = 'http://dyd223.s3.natapp.cc/Roominformation.jsp';
    }
...
<div class="gridContainer clearfix">
    ...
    <div id="middle_box" class="box clearfix">
        <table class="input_table">
            <tbody>
            <tr>
                <td width="40%"><b>游戏出题&nbsp;</b></td>
                <td width="60%" style="margin: 0 auto;">
                    <input id="randWord" type="button" onclick="doRequestUsingGet()" class="main_btn random"
                           value="随机换题">
                </td>
            </tr>
            <tr>
